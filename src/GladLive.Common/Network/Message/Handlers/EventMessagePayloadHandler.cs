...
{
	/// <summary>
	/// <see cref="IEventMessage"/> payload handler.
	/// </summary>
	...
	public abstract class EventMessagePayloadHandler<TPeerType, TPayloadType> : IEventMessageHandler<TPeerType>, IClassLogger
		...
		where TPeerType : INetPeer
	{
		...
		public EventMessagePayloadHandler(ILog logger)
		{
